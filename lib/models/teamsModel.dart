...
final List<TeamModels> teamList = [
  TeamModels(
    ...
    imageUrl:
        "assets/teams/sanjeeb-bhattarai.jpg",
    position: "CEO",
  ),
  TeamModels(
    name: "Samjhana Aryal",
    imageUrl:
        "assets/teams/samjhana-aryal.jpg",
    position: "Director",
  ),
  TeamModels(
    name: "Mounata Ghimire",
    imageUrl:
        "assets/teams/mounata-ghimire.jpg",
    position: "Senior Manager",
  ),
  TeamModels(
    name: "Ranjit Kumar Pandit",
    imageUrl:
        "assets/teams/ranjit-kumar.jpeg",
    position: "Account & Finance Manager",
  ),
  TeamModels(
    name: "Prakriti Sharma",
    imageUrl:
        "assets/teams/prakriti-sharma.jpeg",
    position: "Operation Manager",
  ),
  TeamModels(
    name: "Kiran Bam Thakuri",
    imageUrl:
        "assets/teams/kiran-bam.jpg",
    position: "Associates Officer",
  ),
  TeamModels(
    name: "Khushi Dhital",
    imageUrl:
        "assets/teams/khushi-dhital.jpeg",
    position: "Executive Correspondent",
  ),
  TeamModels(
    name: "Deepa Katwal",
    imageUrl:
        "assets/teams/deepa-katwal.jpeg",
    position: "Documentation Officer",
  ),
  TeamModels(
    name: "Narayan Kandel",
    imageUrl:
        "assets/teams/narayan-kandel.jpg",
