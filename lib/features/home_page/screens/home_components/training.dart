...
import 'package:ghfmun/features/learn_more/screens/learn_more.dart';
...
//  final AutoScrollController controller = AutoScrollController();
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [
            ...
            Color.fromARGB(255, 255, 255, 255),
            Color.fromARGB(255, 138, 216, 238),
          ],
        ),
      ),
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
                fontSize: screenSize.width >= 700 ? 35 : 22,
          ...
          screenSize.width >= 750
              ? Row(
                  ...
                  children: [image(screenSize), text(screenSize , context)],
                )
              : Column(
                  children: [image(screenSize), text(screenSize , context)],
                )
  ...
  Column text(Size screenSize , BuildContext context) {
    return Column(
      ...
      children: [
        ...
        OutlinedButton(
          ...
          onPressed: () {
          navigateToPage(context, const LearnMore(), "learn-more");
          },
          child: const Text(
            "Read More",
  ...
  Padding image(Size screenSize) {
    return Padding(
      padding: EdgeInsets.only(
          left: screenSize.width >= 700 ? screenSize.width * 0.08 : 0,
          right: 15),
      child: Container(
